...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        # conv - relu - 2x2 max pool - affine - relu - affine - softmax
        cache=[]
        out, temp = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
        cache.append(temp)
        cache_shape = out.shape
        out = out.reshape(X.shape[0],-1)
        out, temp = affine_relu_forward(out, W2, b2)
        cache.append(temp)
        out, temp = affine_forward(out, W3, b3)
        cache.append(temp)
        scores = out
        ...
        grads['W1'] = grads['W1'] + self.reg * self.params['W1'] / self.params['W1'].size
        grads['W2'] = grads['W2'] + self.reg * self.params['W2'] / self.params['W2'].size
        grads['W3'] = grads['W3'] + self.reg * self.params['W3'] / self.params['W3'].size
